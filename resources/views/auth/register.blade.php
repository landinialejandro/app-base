        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <label for="organization_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <input type="text" 
                               ...
                               class="w-full border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400">
                    </div>
