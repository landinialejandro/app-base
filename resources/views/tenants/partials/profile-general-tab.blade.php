{{-- FILE: resources/views/tenants/partials/profile-general-tab.blade.php | V3 --}}
...
<x-card>
    @if (!($canEditTenantGeneral ?? false))
        ...
        <div class="form-section">
            ...
            <div class="detail-grid">
                <div class="detail-block">
                    ...
                    <div class="detail-block-value">{{ $tenant->name }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">Razón social</span>
                    <div class="detail-block-value">{{ $settings['legal_name'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">CUIT / ID fiscal</span>
                    <div class="detail-block-value">{{ $settings['tax_id'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">Rubro</span>
                    <div class="detail-block-value">
                        @php
                            $businessType = data_get($settings, 'business_profile.type');
                        @endphp

                        {{ $businessTypeLabels[$businessType] ?? '—' }}
                    </div>
                    <div class="form-help">
                        Define el perfil operativo principal de la empresa.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="detail-grid">
                <div class="detail-block">
                    <span class="detail-block-label">Correo principal</span>
                    <div class="detail-block-value">{{ $settings['email'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">Teléfono</span>
                    <div class="detail-block-value">{{ $settings['phone'] ?? '—' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="detail-grid">
                <div class="detail-block">
                    ...
                    <div class="detail-block-value">{{ $settings['address'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">Ciudad</span>
                    <div class="detail-block-value">{{ $settings['city'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">Provincia / Estado</span>
                    <div class="detail-block-value">{{ $settings['state'] ?? '—' }}</div>
                </div>

                <div class="detail-block">
                    <span class="detail-block-label">País</span>
                    <div class="detail-block-value">{{ $settings['country'] ?? '—' }}</div>
                </div>
            </div>
        </div>
    ...
    <x-dev-component-version name="tenants.partials.profile-general-tab" version="V3" />
</x-card>