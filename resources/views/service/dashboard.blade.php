{{-- FILE: resources/views/service/dashboard.blade.php | V3 --}}
...
@section('content')
    <x-page>
        ...
        <x-card>
            <div class="detail-block">
                <h2 class="content-section-title">Órdenes de servicio</h2>
    ...
    <x-dev-component-version name="service.dashboard" version="V3" align="right" />
@endsection