...
<body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="min-h-screen flex flex-col items-center justify-center">
        ...
        <!-- Selector de tema manual (opcional) -->
        ...
        <div class="text-center max-w-md mx-auto p-6">
            <!-- Logo -->
            <div class="mb-6">
                <svg viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto mx-auto fill-current text-gray-800 dark:text-gray-200">
            ...
            <h1 class="text-4xl font-bold mb-4">Mi Aplicación</h1>
            ...
            @else
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <a href="/login" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition text-center">
                            Login
                        </a>
                        <a href="/app/register" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition text-center">
                            Register
                        </a>
                    </div>
                    <div class="mt-6">
