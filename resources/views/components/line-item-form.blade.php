{{-- FILE: resources/views/components/line-item-form.blade.php | V4 --}}

@props([
    'item',
    'products' => collect(),
    'supportsProductsModule' => true,
    'itemExists' => false,
    'executedQuantity' => 0.0,
    'lineStatusLabel' => 'Pendiente',
    'lineStatusBadge' => 'status-badge--pending',
])
...
@php
    ...
    $supportsProductsModule = (bool) $supportsProductsModule;
    $itemExists = (bool) $itemExists;
    $executedQuantity = (float) $executedQuantity;
@endphp

<div class="form"
    @if ($supportsProductsModule)
        data-action="app-product-autofill"
    ...
    @if ($itemExists)
        <div class="summary-inline-grid">
            ...
            <div class="summary-inline-card">
                ...
                <div class="summary-inline-value">
                    {{ $viewHelper->qty($executedQuantity) }}
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="form-group">
        ...
        <input type="number"
            ...
            class="form-control"
            step="0.01"
            min="{{ $itemExists ? $viewHelper->qtyInput($executedQuantity) : '0.01' }}"
        ...
        @if ($itemExists && $executedQuantity > 0)
            <div class="form-help">
                Ya hay {{ $viewHelper->qty($executedQuantity) }} ejecutados netos en esta línea.
    ...
    <div class="form-group">
        ...
        <input type="number"
            ...
            step="0.01"
            min="0"
            value="{{ old('unit_price', $item->unit_price ?? 0) }}"
            required>
...
<x-dev-component-version name="line-item-form" version="V4" />